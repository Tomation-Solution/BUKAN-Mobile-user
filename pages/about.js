  ...
  return (
      ...
      <TobBar
        body={
          <View style={tw`flex-row justify-between px-3`}>
            ...
            <Ionicon name='md-notifications' style={tw`text-blue-600`} size={30}/>
          </View>
        }
        />
    <ScrollView style={tw`h-full`}>
        ...
        <Image  resizeMode='cover' style={tw`h-10 w-10 mx-auto rounded-lg mb-4`} source={require('../assets/favicon.png')}/>
            <Text style={tw`text-base font-bold text-blue-700 py-1 text-center text-base`}>Welcome Unity Schools </Text>

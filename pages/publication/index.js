  ...
  return (
    <SafeAreaView style={tw`px-2`}>
      <TobBar
        ...
        />
      <View style={tw`flex-row mx-4 justify-between bg-blue-100 my-3 rounded-lg py-2  px-2`}> 
        <Ionicon name='ios-search' size={25} color='#0092ED' style={tw`mr-2`} />
        <TextInput
          placeholder='Search by date'
          style={tw`w-9/12`}
        />
        <Feather name='sliders' style={tw`my-auto`} size={20} color='#0092ED'/>
      </View>

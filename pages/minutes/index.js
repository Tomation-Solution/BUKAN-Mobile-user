...
const Minutes = ({navigation}) => {
    ...
    return (
        <SafeAreaView style={tw`bg-white px-4`}>
            <StatusBar backgroundColor={'#0092ED'} />
            <TobBar
                body={
            ...
            <Text style={[tw`text-base font-bold px-4 pt-4`, {color:'#0092ED'}]}>
                Upload Minutes
            </Text>
            ...
            <Pressable onPress={()=>_pickDocument()} style={[tw`${document ? 'pb-1 pt-3' :'py-5'} px-2 my-4 mx-auto  w-11/12 `,{borderWidth:1,borderColor:'#0092ED', borderStyle: 'dashed',
                borderRadius: 1, borderStyle:'dashed',}]}>
                
                <Ionicon name="ios-cloud-upload" style={tw`m-auto`} color={document ? '#0092ED': 'rgba(0,0,0,0.4)'} size={50}/>
